...
(function()
{
	function addCombo( editor, comboName, styleType, lang, entries, defaultLabel, styleDefinition )
	{
		...
		editor.ui.addRichCombo( comboName,
		  {label : "行距",title: lang.panelTitle,className: 'cke_' + (styleType == 'size' ? 'fontSize' : 'font'),
		   panel :{css : [CKEDITOR.skin.getPath("editor")].concat( config.contentsCss ),multiSelect : false,
...
CKEDITOR.config.lineheight_sizes = 
	'normal;1.5em;1.75em;2em;3em;4em;5em;100%;110%;120%;130%;140%;150%;160%;170%;180%;190%;200%;210%;220%;230%;240%;250%;260%;270%;280%;290%;300%;400%;500%';
