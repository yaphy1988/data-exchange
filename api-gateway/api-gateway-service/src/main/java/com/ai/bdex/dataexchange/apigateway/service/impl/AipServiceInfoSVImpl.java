...
import com.ai.bdex.dataexchange.apigateway.dao.mapper.AipServiceInfoMapper;
...
public class AipServiceInfoSVImpl implements IAipServiceInfoSV{
	...
	public AipServiceInfo getAipServiceInfo(String serviceId,
		...
		try{
			return getAipServiceInfo(serviceId,serviceVersion,APIConstants.AipService.SERVICE_VALID_STATUS);
		}catch(Exception e){
	...
	public PageResponseDTO<AipServiceInfoDTO> selectServiceWithPageWithInitVersion(
		...
		try{
			if(null!=req){
				req.setVersion(APIConstants.AipService.SERVICE_INIT_VERSION);
			}
	...
	public PageResponseDTO<AipServiceInfoDTO> selectServiceWithPageWithInitVersionAndValidstatus(
		...
		try{
			if(null!=req){
				req.setVersion(APIConstants.AipService.SERVICE_INIT_VERSION);
				req.setStatus(APIConstants.AipService.SERVICE_VALID_STATUS);
			}
	        PageResponseDTO<AipServiceInfoDTO> rspDto= selectServiceWithPage(req);
			return rspDto;
		}catch(Exception e){
	...
	public AipServiceInfo selectServiceByServiceIdWithInitversion(
		...
		return this.getAipServiceInfo(serviceId, APIConstants.AipService.SERVICE_INIT_VERSION,null);
	}
