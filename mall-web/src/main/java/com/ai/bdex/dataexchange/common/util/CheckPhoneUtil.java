...
public class CheckPhoneUtil {
    ...
    /**
     * 中国电信号码格式验证 手机段： (133/153/180/181/189/177/1700[2-3])
     * **/
    private static final String CHINA_TELECOM_PATTERN = "(^1(33|53|77|8[019])\\d{8}$)|(^1700[2-3]\\d{6}$)";

    /**
     * 中国联通号码格式验证 手机段：(130/131/132/155/156/185/186/145/175/176/1709[2-3])
     * **/
    private static final String CHINA_UNICOM_PATTERN = "(^1(3[0-2]|4[5]|5[56]|7[56]|8[56])\\d{8}$)|(^1709[2-3]\\d{6}$)";

    /**
     * 中国移动号码格式验证
     * 手机段：(134/135/136/137/138/139/150/151/152/157/158/159/182/183/184/187/188/147/178/1705[2-3])
     * **/
    private static final String CHINA_MOBILE_PATTERN = "(^1(3[4-9]|4[7]|5[0-27-9]|7[8]|8[2-478])\\d{8}$)|(^1705[2-3]\\d{6}$)";
    /**
     * 验证电话号码的格式
     *
     * @param str
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isChinaTelecomPhoneNum("17000581369"));
        System.out.println(isChinaTelecomPhoneNum("13306061248"));
        System.out.println(isChinaTelecomPhoneNum("17750581369,13306061248"));
        System.out.println(isChinaTelecomPhoneNum("17750581369 13306061248"));
        System.out.println(isChinaTelecomPhoneNum("17750581369、13306061248"));
        System.out.println(isChinaTelecomPhoneNum("0596-3370653"));
