...
public class PageModuleReqDTO  extends BaseInfo{
    ...
    private List<PageModuleReqDTO> subPageModuleList;
    
	public List<PageModuleReqDTO> getSubPageModuleList() {
		return subPageModuleList;
	}

	public void setSubPageModuleList(List<PageModuleReqDTO> subPageModuleList) {
