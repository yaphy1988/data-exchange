...
public class SolrDeltaImportClearJob {
    private static Logger logger = LoggerFactory.getLogger(SolrDeltaImportClearJob.class);
    public static void main(String[] args){
        try {
             Utils.getCtx().getBean("deltaIndexServiceRSV",IDeltaIndexServiceRSV.class).deltaFullImport(SolrCoreEnum.GDS.getCode(), true);
             logger.error("====================================重建索引成功！====================================");
